...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 36/*invalid_command*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 36/*invalid_command*/);
}
}
...
_cls_rover_mon0 _cls_inst = _cls_rover_mon0._get_cls_rover_mon0_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 32/*get_change_data*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 32/*get_change_data*/);
}
}
...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 40/*send_command*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 40/*send_command*/);
}
}
...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 44/*check_speed*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 44/*check_speed*/);
}
}
...
_cls_rover_mon0 _cls_inst = _cls_rover_mon0._get_cls_rover_mon0_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 34/*valid_command*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 34/*valid_command*/);
}
}
...
_cls_inst.x = x;
_cls_inst.y = y;
_cls_inst._call(thisJoinPoint.getSignature().toString(), 42/*check_nav*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 42/*check_nav*/);
}
}
...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 46/*check_vert_ang*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 46/*check_vert_ang*/);
}
}
...
_cls_rover_mon0 _cls_inst = _cls_rover_mon0._get_cls_rover_mon0_inst();
_cls_inst.message = message;
_cls_inst._call(thisJoinPoint.getSignature().toString(), 38/*send_move_on*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 38/*send_move_on*/);
}
}
}